...
export function InvoiceDetails({ isOpen, onClose, invoice, barbershopName }: InvoiceDetailsProps) {
    ...
    const handleShare = async () => {
        const shareData = {
            ...
            url: window.location.href // Opcional, ou link direto se houver
        }
    ...
    return (
        <Sheet open={isOpen} onOpenChange={onClose}>
            ...
            <SheetContent className="w-full h-full md:h-auto sm:max-w-md bg-[#141518] border-l border-white/5 text-white overflow-y-auto p-0 md:p-6 md:rounded-l-2xl">
