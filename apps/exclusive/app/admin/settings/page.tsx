...
export default function SettingsPage() {
    ...
    return (
        <div className="min-h-screen bg-background text-foreground flex flex-col">
            <Header />
            <div className="container mx-auto p-4 md:p-8 max-w-5xl pb-24 text-white flex-1">
                <ConfirmDialog
                                    ...
                                    <div className="grid md:grid-cols-2 gap-8">
                                        <div className="space-y-3">
                                            ...
                                            <div className="flex items-center gap-4">
                                                <div className="h-12 w-12 rounded-lg border border-secondary" style={{ backgroundColor: storeData.themeConfig?.primaryColor || "#8162FF" }} />
                                                <Input
                                                    disabled={currentPlan !== "EXCLUSIVE"}
                                                    type="color"
                                                    value={storeData.themeConfig?.primaryColor || "#8162FF"}
                                                    onChange={(e) => {
                                                        setStoreData({
                                                            ...storeData,
